...
int main(){
    ...
    prog.add(PrintTensor("d_matrix1.index({0,1,2})", d_matrix1.index({0,1,2})));
    // Tensor res = poplin::matMulGrouped(graph, d_matrix1.index({0,1,2}), d_matrix2.index({2,1,0}), prog, FLOAT, "dtemp_out");
